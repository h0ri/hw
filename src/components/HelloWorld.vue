  ...
  <v-col>
    <v-sheet class="mb-3">
      <v-toolbar flat color="white" class="first d-none d-md-block">
        ...
        <v-spacer></v-spacer>
        <v-btn type="button" name="button" color="error" class="ml-3" @click="overlay=!overlay">予定を追加する</v-btn>
        <v-btn type="button" name="button" color="success" class="ml-3" @click="overlay2=!overlay2">予定を更新する</v-btn>
      </v-toolbar>
      <v-toolbar flat color="white" class="first d-sm-block d-md-none">
        <v-row>
          <v-btn outlined class="mr-4" color="grey darken-2" @click="setToday">
            Today
          </v-btn>
      ...
      <v-toolbar flat color="white" class="first d-sm-block d-md-none">
        <v-row>
          <v-btn type="button" name="button" color="error" @click="overlay=!overlay">予定を追加する</v-btn>
          <v-btn type="button" name="button" color="success" class="ml-3" @click="overlay2=!overlay2">予定を更新する</v-btn>
        </v-row>
      </v-toolbar>
    </v-sheet>
    <v-sheet class="sheet-sp" height="600">
      <v-calendar ref="calendar" v-model="focus" color="primary" :events="events" event-start="content" :event-name="getPersonName" :event-color="getEventColor" @change.native="updateRange" :type="type"></v-calendar>
